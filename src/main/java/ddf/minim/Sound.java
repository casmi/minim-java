...
public class Sound
{
  ...
  /**
   * Creates an instance of Sound that will use the Javasound implementation.
   */
  public Sound() 
  {
    mimp = new JSMinim();
  ...
  /**
   * Creates an instance of Sound that will use the provided implementation for audio.
   * 
   * @param msp
